...
"   gl_FragColor = vec4(clr.r, clr.g, clr.b, 0.8);\n" \
"}\n"
/*}}}*/
...
#endif
	for (int i=0; i<LAYERS; ++i) {
		build_world(textures[i], TEXTURE_WIDTH, SCREEN_HEIGHT, RULE, BASERATE-ratedelta*i, i==LAYERS-1?0:i%3, ((i==LAYERS-1)||(i==0))?255:191);
	}
